 ...
 *
 * Effect<A, E, R> 
 * Orignally, It was Effect<R,E,A> but it is changed to Effect<A, E, R> 
 * 
 ...
 *
 *  이들을 각각의 분리된 채널로 생각하자. 이 모든 것들은 프로그램 내에서 상호작용할 수 있는 채널로 생각하자.
 ...
 * (타입 추론이 강력하여 타입을 일일이 지정할 일이 드물다
